...
struct JohnsonLever: View {
    @Binding var currentAngle: Double
    var minAngle: Double = 90
    var maxAngle: Double = 270
...
struct JohnsonLeverPreview: View {
...
//            Spacer()
            ...
            JohnsonLever(currentAngle: $angle, minAngle: 90, maxAngle: 270)
